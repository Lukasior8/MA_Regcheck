...
# clean GPT data_gpt and new gpt data
...
### hier eventuell ausserdem auch anzahl einträge ingesamt? und pro psp....
### und auch noch für den new dataset
...
ggplot(data_psp_filesize, aes(x = size_kb)) +
  ...
  # Optional: Boxplot für eine zusätzliche visuelle Darstellung der Verteilung
  ggplot(data_psp_filesize, aes(y = size_kb)) +
    geom_boxplot(fill = "lightgreen") +
    labs(title = "Boxplot der Dateigrößen (in KB)", y = "Dateigröße (KB)") +
    theme_minimal()
