...
Sensitivity (Empfindlichkeit) misst, wie gut das Modell die tatsächlichen positiven Fälle für jede Klasse erkennt (True Positives). Es beantwortet die Frage: Von den tatsächlichen Positiven, wie viele wurden richtig als positiv klassifiziert?

Specificity (Spezifität) misst, wie gut das Modell die negativen Fälle korrekt identifiziert (True Negatives). Es beantwortet die Frage: Von den tatsächlichen Negativen, wie viele wurden richtig als negativ klassifiziert?
