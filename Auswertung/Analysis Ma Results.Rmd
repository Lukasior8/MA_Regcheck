...
for (type_experimenttype in types_experimenttype) {
  ...
  if (!is.null(nc) && nc > 1) {
    ...
    if (nrow(combined_data_experimenttype) > 0) {
      ...
      cat("p-Wert_experimenttype:", round(kappa_result_experimenttype$p.value, 2), "\n")
      cat("z-Wert_experimenttype:", round(kappa_result_experimenttype$statistic, 2), "\n")
